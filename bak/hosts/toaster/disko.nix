            ...
            luks = {
              ...
              content = {
                ...
                settings = {
                  ...
                  # TPM2 auto-unlock: Seals LUKS key to TPM PCRs for passwordless boot
                  # Setup: systemd-cryptenroll --tpm2-device=auto /dev/nvme0n1p2
            ...
            luks = {
              ...
              content = {
                ...
                settings = {
                  ...
                  # keyFile = "/tmp/secret.key";
                  # TPM2 auto-unlock: Seals LUKS key to TPM PCRs for passwordless boot
                  # Setup: systemd-cryptenroll --tpm2-device=auto /dev/nvme1n1p2
                  crypttabExtraOpts = [ "tpm2-device=auto" ];
                };
                ...
                content = {
                  ...
                  subvolumes = {
                    ...
                    "@log" = {
                      mountpoint = "/var/log";
                      mountOptions = [ "compress=zstd:1" "noatime" ];  # Light compression for logs
                    };
                    "@cache" = {
