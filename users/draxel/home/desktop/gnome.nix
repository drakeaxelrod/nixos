...

{
  dconf.settings = {
    ...
    "org/gnome/desktop/background" = {
      picture-uri = "file://${config.home.homeDirectory}/.config/nixos/assets/wallpapers/nix-wallpaper-binary-red_8k.png";
      picture-uri-dark = "file://${config.home.homeDirectory}/.config/nixos/assets/wallpapers/nix-wallpaper-binary-red_8k.png";
